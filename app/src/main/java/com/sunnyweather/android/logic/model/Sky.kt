...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY0_DAY" to Sky("多云", R.mipmap.ic_partly_cloud_day, R.mipmap.bg_partly_cloudy_day),
    "PARTLY_CLOUDY0_NIGHT" to Sky("多云", R.mipmap.ic_partly_cloud_night, R.mipmap.bg_partly_cloudy_night),
    ...
    "SLEET" to Sky("雨夹雪", R.mipmap.ic_sleet, R.mipmap.bg_snow),
...
//根据输入的天气状态代码 (skycon)，从 sky 映射中获取相应的 Sky 对象。
//如果 sky 映射中没有对应的 skycon 键，则默认返回表示晴天的 Sky 对象。
//?:是 Kotlin 中的 Elvis 操作符。它用于在左侧表达式结果为 null 时，提供一个默认值。
